...
var parkStyle = function(feature) {
  if (feature.properties.CAMPING == "Yes"){
    return {fillColor: "#256F5B", fillOpacity: 0.8, color: "#003829", weight: 2, radius: 6};  }
    if (feature.properties.CAMPING == "No"){
      return {fillColor: "#DC7C4E", fillOpacity: 0.8, color: "#9A3E12", weight: 2, radius: 6};  }
    };


    var trailStyle = function(feature) {
      if (feature.properties.DIFFICULTY == "Easiest"){
        return {color: "#256F5B", opacity: 0.8, weight: 3};  }
        if (feature.properties.DIFFICULTY == "More Difficult"){
          return {color: "#D3562B", opacity: 0.8, weight: 3};  }
          if (feature.properties.DIFFICULTY == "Most Difficult"){
            return {color: "#870003", opacity: 0.8, weight: 3};  }
      else{
        return{weight: 3};}
          ...
          var parkShapeStyle = function(feature) {
            return{fillOpacity: 0.1, color: "#323814", opacity: 0.5, weight: 2, dashArray: "6 4"};
          };

          var all_trailStyle = function(feature) {
            return{color: "#743A13", opacity: 0.8, weight: 2, dashArray: "2 4"};
          };
          ...
          var each_PA_Trail = function(feature, layer){
            ...
            layer.on('mouseover', function() { layer.setStyle(all_trailOver);});
            layer.on('mouseout', function() { layer.setStyle(all_trailOut);});
